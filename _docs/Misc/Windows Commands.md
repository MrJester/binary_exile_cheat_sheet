...
schtasksStart time <br> <i> HH:MM:SSFrequency: MINUTE, HOURLY, DAILY, ONCE, ONSTART, ONLOGON, ONIDLE </i> | <code> net use \\[targetIP] [password] /u:[admin_user] <br> <br> sc \\[targetIP] query schedule (*make sure it is running*) <br> <br> *sc \\[targetIP] start schedule* <br> <br> schtasks /create /ru SYSTEM /tn [taskname] /s [targetIP] /u [user] /p [password] /sc [frequency] /MO [modifier] /st [starttime] /sd [startdate] /tr [command] <br> <br> schtasks /query /s [targetIP] </code> 
